...
class TestIsoGraph(object):
    ...
    * testing data access and dfs (too small for heuristic)
    ...
    S1 = cliquematch.Graph.from_file("./tests/sample_read1a.mtx", False).adjacency_list
    S2 = cliquematch.Graph.from_file("./tests/sample_read1b.mtx", False).adjacency_list
