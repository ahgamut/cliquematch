# -*- coding: utf-8 -*-
"""
    cliquematch.tests.test_l2l
    ~~~~~~~~~~~~~~~~~~~~~~~~~~

    testcases for cliquematch.L2LGraph
...
class TestL2LGraph(object):
    ...
    * testing time limits with and continue search
    ...
    def test_edge_build(self):
        ...
        with pytest.warns(UserWarning):
            G2 = cliquematch.L2LGraph(S1, S2, d1=eucd)
            with pytest.raises(RuntimeError):
                G2.build_edges()
            with pytest.raises(RuntimeError):
