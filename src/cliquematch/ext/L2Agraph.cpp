...
GraphTemplate<py::list, double, Eigen::Ref<DoubleMatrixR>>::GraphTemplate(
    ...
    : GraphTemplate<py::list, double, Eigen::Ref<DoubleMatrixR>>(
...
template struct GraphTemplate<py::list, double, Eigen::Ref<DoubleMatrixR>>;

// required for wrapper template to instantiate
// for calling from cm_base.cpp
void init_L2Agraph(pybind11::module& mm)
{
    init_GraphTemplate<py::list, double, Eigen::Ref<DoubleMatrixR>>(mm, "L2AGraph");
}
