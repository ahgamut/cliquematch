...
edges_from_relsets<Eigen::Ref<DoubleMatrixR>, double, Eigen::Ref<DoubleMatrixR>>(
...
template std::vector<std::set<std::size_t>>
efr_condition<Eigen::Ref<DoubleMatrixR>, double, Eigen::Ref<DoubleMatrixR>>(
    std::size_t&, std::size_t&, const relset<Eigen::Ref<DoubleMatrixR>, double>&,
    const relset<Eigen::Ref<DoubleMatrixR>, double>&, const double,
...
template <>
GraphTemplate<Eigen::Ref<DoubleMatrixR>, double,
              Eigen::Ref<DoubleMatrixR>>::GraphTemplate(Eigen::Ref<DoubleMatrixR>& pts1,
                                                        std::size_t pts1_len,
